...
func (u *UserStorage) CreateUser(ctx context.Context, user domain.User) (err error) {
	...
	_, err = u.db.ExecContext(ctx, `INSERT INTO users (email, username, password, role)
					VALUES ($1, $2, $3, $4)`,
		dbUser.Email,
		dbUser.Username,
		dbUser.Password,
...
func (u *UserStorage) GetUserByEmail(ctx context.Context, email string) (domain.User, error) {
